...
describe 'tomcat::install::archive' do
  ...
  describe 'general assumptions' do
    ...
    it do
      is_expected.to contain_group('tomcat').with('ensure' => 'present',
                                                  'system' => true)
    end
    it do
      is_expected.to contain_user('tomcat').with('ensure' => 'present',
                                                 'gid'    => 'tomcat',
                                                 'system' => true)
    end
  end
  describe 'default params' do
    describe 'RedHat family' do
      ...
      context 'on RedHat 7' do
        let :facts do
          super().merge(operatingsystem: 'RedHat',
                        operatingsystemmajrelease: '7')
        end
    ...
    describe 'SuSE family' do
      ...
      context 'on OpenSuSE' do
        let :facts do
          super().merge(operatingsystem: 'OpenSuSE',
      ...
      context 'on SLES 12.0' do
        let :facts do
          super().merge(operatingsystem: 'SLES',
